...
class ImageReadWrite(object):
    ...
    def read(self, filename):
        ...
        if USE_PIL:
            ...
            return img_grey, channel_one, channel_two, channel_three
        elif USE_SCIPY:
            greyscale = True
